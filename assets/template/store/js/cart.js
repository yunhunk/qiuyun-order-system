    ...
    if (type == 'rmb') {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.code == 1) {
                    alert(data.msg);
                    if (top.location != self.location) top.location.href = serverPath + 'user/shop.php?buyok=1';
                    ...
                    var confirmobj = layer.confirm('你的余额不足，请充值！', {
                        ...
                        top.location.href = serverPath + 'user/#chongzhi';
                    }, function() {
                    ...
                    var confirmobj = layer.confirm('你还未登录，是否现在登录？', {
                        ...
                        top.location.href = serverPath + 'user/login.php';
                    }, function() {
                        top.location.href = serverPath + 'user/reg.php';
                    }, function() {
                        layer.close(confirmobj);
                    });
                } else {
...
function cancel(orderid) {
    ...
    $.ajax({
        type: "POST",
        url: serverPath + "ajax.php?act=cart_cancel",
        data: {
            orderid: orderid,
            hashsalt: hashsalt
        },
...
var GoodsCart = {
    CartList: function(type) {
        type = type || 1;
        if (type == 1) layer.load(2, {
            time: 9999999
        });
        $.ajax({
            type: "get",
            url: serverPath + "ajax.php?act=cart_list",
            dataType: "json",
            success: function(data) {
            ...
            success: function(data) {
                if (data.code == 0) {
                    ...
                    $.each(data.data, function(key, val) {
                        ...
                        content += '<li>\n' + '          <a href="' + url + '">\n' + '              <img src="' + val.shopimg + '" onerror="this.src=\'' + serverPath + 'assets/template/store/picture/error_img.png\'" style="height: ' + [$(window).width() > 460 ? '36' : '26'] + 'vh" class="proimg"/>\n' + '              <p class="tit">' + val.name + '</p>\n' + '              <p class="price">￥' + val.price + '<img src="' + serverPath + 'assets/template/store/images/f3.png"/></p>\n' + '          </a>\n' + '      </li>';
                    });
    ...
    Success: function(data) {
        ...
        $(".num1").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: serverPath + "ajax.php?act=cart_num",
                data: {
                    id: id,
                    num: (count - 1)
                },
        ...
        $(".del").click(function() {
            ...
            layer.open({
                ...
                btn1: function(layero, index) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: serverPath + "ajax.php?act=cart_shop_del",
                        data: {
                            id: id
                        },
                        dataType: "json",
    ...
    submit: function() {
        ...
        $.ajax({
            type: "post",
            url: serverPath + "ajax.php?act=cart_buy",
            data: {
                shop_id: arr,
                hashsalt: hashsalt
            },
    ...
    PaySubmit: function(data) {
        ...
        if (paytype == 'help') {
                ...
                success: function(data) {
                    ...
                    if (data.code == 1) {
                        ...
                        var confirmobj = layer.confirm('你的余额不足，请充值！', {
                            ...
                            window.location.href = serverPath + 'user/recharge.php';
                        }, function() {
                            layer.close(confirmobj);
                        });
                    } else if (data.code == -4) {
            ...
            window.location.href = serverPath + 'other/submit.php?type=' + paytype + '&orderid=' + orderid;
        }
    }
}