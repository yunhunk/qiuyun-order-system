/** layer-v3.4.0 星河优化版 Web 通用弹出层组件 MIT License */;
! function (e, t) {
    "use strict";
    var i, n, a = e.layui && layui.define,
        o = {
            ...
            isWap: function () {
                ...
                var mRex = new RegExp('Android\|iPhone\|SymbianOS\|Windows Phone', 'i');
                if (mRex.test(userAgentInfo)) {
                    return true
                }
                return false
            },
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        if ('undefined' !== typeof window.jQuery) {
            winArea = [jQuery(window).height(), jQuery(window).width()];
            oft.jQuery = jQuery;
        }
        else {
            if ('undefined' != typeof window.innerHeight && window.innerHeight > 100) {
                winArea = [window.innerHeight, window.innerWidth]
            } else {
                winArea = [window.screen.availHeight || window.screen.height, window.screen.availWidth || window.screen.width]
            }
        }

        oft.isWap = helper.isWap();
        if (!oft.isWap) {
            if (parseFloat(winArea[0] / winArea[1]) > 0.9) {
                winArea[0] = a[1] >= 480 ? a[1] : a[1] * 2.5 + 150
            }
        } else {
            if (parseFloat(winArea[0] / winArea[1]) > 2.2) {
                winArea[0] = parseInt(winArea[1] * 1.6)
            } else if (winArea[0] < winArea[1]) {
                winArea[0] = parseInt(winArea[1] * 1.4)
            }
        }
        oft.winArea = winArea;
        oft.layArea = a;
        oft.top = parseInt((oft.winArea[0] - oft.layArea[1]) / 2);
        console.log('offset', oft);
        e.offsetTop = (winArea[0] - a[1]) / 2, e.offsetLeft = (winArea[1] - a[0]) / 2, o ? (e.offsetTop = t.offset[0], e.offsetLeft = t.offset[1] || e.offsetLeft) : "auto" !== t.offset && ("t" === t.offset ? e.offsetTop = 0 : "r" === t.offset ? e.offsetLeft = winArea[1] - a[0] : "b" === t.offset ? e.offsetTop = winArea[0] - a[1] : "l" === t.offset ? e.offsetLeft = 0 : "lt" === t.offset ? (e.offsetTop = 0, e.offsetLeft = 0) : "lb" === t.offset ? (e.offsetTop = winArea[0] - a[1], e.offsetLeft = 0) : "rt" === t.offset ? (e.offsetTop = 0, e.offsetLeft = winArea[1] - a[0]) : "rb" === t.offset ? (e.offsetTop = winArea[0] - a[1], e.offsetLeft = winArea[1] - a[0]) : e.offsetTop = t.offset), t.fixed || (e.offsetTop = /%$/.test(e.offsetTop) ? winArea[0] * parseFloat(e.offsetTop) / 100 : parseFloat(e.offsetTop), e.offsetLeft = /%$/.test(e.offsetLeft) ? winArea[1] * parseFloat(e.offsetLeft) / 100 : parseFloat(e.offsetLeft), e.offsetTop += n.scrollTop(), e.offsetLeft += n.scrollLeft()), i.attr("minLeft") && (e.offsetTop = winArea[0] - (i.find(l[1]).outerHeight() || 0), e.offsetLeft = i.css("left")), i.css({
            top: oft.top + 'px',
            left: e.offsetLeft
        })
    }, s.pt.tips = function () {
