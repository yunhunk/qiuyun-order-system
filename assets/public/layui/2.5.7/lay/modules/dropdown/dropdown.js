...
layui.define(["jquery", "laytpl"], function(n) {
    ...
    function u(n) {
        if (n && 0 < n.length) {
            for (var t = 0, i = new Array(n.length), e = 0; e < n.length; e++)
                for (var o = n[e], s = 0; s < o.length; s++) o[s].header && o[s].fixed && (t++, i[e] = o[s], o.splice(s, 1), s--);
            if (0 < t) return i
        }
        return null
    }
    var w = window.MICROANSWER_DROPDOWAN || "dropdown",
        ...
        x = {
            ...
            backgroundColor: "#FFF",
            cssLink: "https://cdn.jsdelivr.net/gh/microanswer/layui_dropdown@2.3.4/dist/dropdown.css",
            immed: !1,
            arrow: !0,
            templateMenuSptor: "[]",
            menuSplitor: !0,
    ...
    function d(n, o) {
        a(n || "[lay-" + w + "]").each(function() {
            var n = a(this),
                t = new Function("return " + (n.attr("lay-" + w) || "{}"))();
            n.removeAttr("lay-" + w);
            var i = a.extend({}, t, o || {}),
                e = n.data(w) || new s(n);
            n.data(w, e), e.init(i)
    ...
    s.prototype.onMenuLaytplEnd = function(n) {
        ...
        if (t.fcd = !1, t.mic = !1, t.opened = !1, t.option ? t.option = a.extend(t.option, n || {}) : t.option = a.extend({
            ...
            var e, o;
            if (t.option.templateMenu) o = -1 === t.option.templateMenu.indexOf("#") ? "#" + t.option.templateMenu : t.option.templateMenu, e = a(o).text();
            else t.option.templateMenuStr && (e = t.option.templateMenuStr);
            ...
            l(e).render(s, function(n) {
                t.option.menus = function(n, t) {
                    ...
                    for (var i, e, o = t.charAt(0), s = t.charAt(1), d = n.length, r = 0, a = h, l = !1, p = []; r < d;) {
                        var u = n.charAt(r);
                        a !== h || l ? a !== c || l ? a === m && (l ? (e.srcStr += u, l = !1) : "\\" === u ? l = !0 : u === s ? (e = f(e.srcStr), i.push(e), a = c) : e.srcStr += u) : o === u ? (e = {
                            srcStr: ""
                        }, a = m) : s === u && (a = h) : o === u && (i = [], p.push(i), a = c), r += 1
                    }
                    return p
        ...
        if (this.$down) {
            var n, t, i, e, o = this.$dom.offset(),
                s = this.$dom.outerHeight(),
                d = this.$dom.outerWidth(),
                r = o.left,
                a = o.top - window.pageYOffset,
                l = this.$down.outerHeight(),
                p = this.$down.outerWidth();
        ...
        if ("next" === n) this.$dom.after(this.$down);
        else if ("before" === n) this.$dom.before(this.$down);
        else {
        ...
        d.$down.find(".layu-dropdown-menu-wrap").on("mousewheel", function(n) {
            ...
            0 < i ? (50 < i && (i = 50), d.scrolling = !0, t.animate({
                scrollTop: t.scrollTop() + i
            }, {
                duration: 170,
                complete: function() {
                    d.scrolling = !1
                }
            })) : i < 0 ? (i < -50 && (i = -50), d.scrolling = !0, t.animate({
                scrollTop: t.scrollTop() + i
            }, {
                duration: 170,
                complete: function() {
            ...
            var n = a(this),
                t = (n.attr("lay-event") || "").trim();
            if (t) {
                var i = w + "(" + d.option.filter + ")." + p,
                    e = n.parents("[dropdown-menu-index]"),
                ...
                d.option.onItemClick && d.option.onItemClick(t, s), r(i, {
                    event: t,
                    data: s
                }), d.hide()
    ...
    }, d(), window[w + "_useOwnCss"] || layui.link(window[w + "_cssLink"] || x.cssLink, function() {}, w + "_css"), n(w, {
        suite: d,
