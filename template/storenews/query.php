...
<style>
    ...
    .footer.footer-bar ul li a.active {
        color: #1492fb !important;
    }
    .footer.footer-bar ul li i {
        display: block !important;
...
<div class="fui-page-group">
    <div class="fui-content">
        ...
        <div class="layui-card-body" style="padding: 1em;padding-bottom: 1em;overflow:hidden;">
