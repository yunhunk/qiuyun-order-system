...
<div class="panel-heading" style="text-align: center;"><h3 class="panel-title">
	...
	<div class="list-group">
			...
			<div class="tab-pane fade in active">
				<div class="form-group">
					<input type="text"id="kuaishou_url" value="" class="form-control" placeholder="请输入**作品链接" required="">
				</div>
...
function getkuaishouid(){
	...
	if(kuauishouurl.indexOf('gifshow.com')<0 && kuauishouurl.indexOf('kuaishou.com')<0){alert('请输入正确的**作品链接！');return false;}
	$('#kuaishou_v').hide();
	try{
