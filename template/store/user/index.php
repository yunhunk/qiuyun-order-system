...
?>
        <div style="overflow: hidden;height: 9rem;position: relative;background: #fff">
            <div class="headinfo" style="z-index:100;border: none;">
                ...
                <div class="child">
                    <a href="javascript:;">
                        ...
                        <div class="num"><?php echo $userrow['money'] ?></div>
                    </a>
                    <a href="recharge.php">
            ...
            <img class="cover-img" src="<?php echo $cdnserver ?>assets/template/store/picture/cover.png">
        </div>
            ...
            <div class="fui-according-group " style="display: block;margin-top:unset;">
                <div class="fui-according expanded">
                    ...
                    <div class="fui-according-content" style="display: block;">
                        <div class="fui-icon-group selecter col-<?php if ($userrow['power'] >= 1) {echo '5';} else {echo '3';}?>">
                            <a class="fui-icon-col external" href="tixian.php">
                                <div class="icon icon-green radius">
                                    <i class="fa fa-jpy" style="/* color: #ff6a54; */"></i>
                                </div>
                                <div class="text">提现管理</div>
                            </a>
                            ...
                            <?php if ($userrow['power'] >= 1): ?>
                                ...
                                <?php if ($conf['power'] == 1 && $conf['fenzhan_upgrade'] == 1): ?>
                                <a class="fui-icon-col external" href="upsite.php">
                                    <div class="icon icon-pink radius"><i class="icon icon-fenxiao"></i></div>
                                    <div class="text">提升等级</div>
                                </a>
                                <?php endif?>
                            <?php endif?>
                            <?php if ($userrow['power'] == 0): ?>
                            <a class="fui-icon-col external" href="regsite.php?zid=<?php echo $userrow['zid'] ?>">
                                <div class="icon icon-pink radius"><i class="fa fa-users"></i></div>
                                <div class="text">开通分站</div>
                            </a>
                            <?php endif?>
                        </div>
                    </div>
                ...
                <div class="fui-according expanded">
                    ...
                    <div class="fui-according-content" style="display: block">
                        <div class="fui-icon-group selecter col-<?php if ($userrow['power'] > 0) {echo '3';} else {echo '1';}?>">
                            ...
                            <?php if ($userrow['power'] > 0) {?>
                            <a class="fui-icon-col external" href="tixian.php?#skimg">
                                <div class="icon icon-orange radius">
