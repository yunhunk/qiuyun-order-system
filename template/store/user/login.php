...
if (isset($_GET['back'])) {
    ...
    if (!preg_match('/http/', $back)) {
        $back = rtrim(strtolower($weburl), 'user/') . '/' . $back;
    }
} else {
    $back = './index.php';
}
            ...
            <div class="fui-modal popup-modal in">
                <div class="account-layer login" style="max-height:unset;margin:-13rem 0 0 -7.75rem;">
                        <div class="account-main">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input type="text" name="user" id="user" value="" class="form-control input-lg" required="required" placeholder="用户名"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input type="password" name="pass" id="pass" class="form-control input-lg" required="required" placeholder="密码"/>
                                </div>
                            </div>
                            <?php if (@\core\Template::isNeedCodeCaptcha('login')) {?>
                                <?php if ($conf['captcha_open'] >= 1 && $conf['captcha_open_login'] == 1) {?>
                                ...
                                <div class="form-group">
                                  <div class="input-group">
                                      <div class="input-group-addon"><span class="fa fa-fw fa-adjust"></span></div>
                                      <input type="text" name="code" id="code" class="form-control input-lg" required="required" placeholder="输入验证码"/>
                        ...
                        <div style="text-align: center;margin-bottom: 5px;color:#999;margin-top: 15px;">
                            ...
                            <?php if ($conf['login_qq'] >= 1) {?><div onclick="javascript:connect('qq')" style="width: 42px;height:42px; border: 1px solid rgba(213, 213, 213, 1); border-radius: 21px;  margin: 15px ; margin-top: 10px;   background-image: url(<?php echo $cdnserver ?>assets/img/logo2.png);background-size: 100%;display: inline-block;"></div><?php }?>
                            <?php if ($conf['login_wx'] >= 1) {?><div onclick="javascript:connect('wx')" style=" width: 42px;height:42px; border: 1px solid rgba(213, 213, 213, 1); border-radius: 21px;  margin: 15px ; margin-top: 10px;   background-image: url(<?php echo $cdnserver ?>assets/img/wx.png);background-size: 100%;display: inline-block;"></div><?php }?>
                        <?php }?>
                        </div>
...
<script src="<?php echo $cdnserver ?>assets/js/login.js?ver=<?php echo VERSION ?>"></script>
<script>
function goback()
{
