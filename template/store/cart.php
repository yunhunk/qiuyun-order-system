...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo $cdnserver ?>assets/template/store/css/cart.css"/>
</head>
...
<div class="headerbox">
    <div class="header">
        <div class="headerC">
            <div class="headerL">
                <a onclick="javascript:history.back(-1)" class="goback"><img src="<?php echo $cdnserver ?>assets/template/store/images/goback.png"></a>
            </div>
...
<div class="gwcbox">
    ...
    <div id="CartNull" style="display: none">
        <div class="paysuccess">
            <div class="pay30">
                <img src="<?php echo $cdnserver ?>assets/template/store/images/gwc.jpg">
                <p>购物车还是空的</p>
            </div>
            <div class="pay40">
                <a href="./">去逛逛</a>
    ...
    <div class="likebox" style="padding-bottom: 8em;">
        <div class="likeTit">
            <img src="<?php echo $cdnserver ?>assets/template/store/images/heart.png"><span>猜你喜欢</span>
        </div>
        <ul id="GoodsRound"></ul>
...
<script src="<?php echo $cdnserver ?>assets/template/store/js/cart.js?<?php echo VERSION ?>"></script>
<script>
    GoodsCart.CartList();
</script>
