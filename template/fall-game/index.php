...
<!--顶部导航-->
        ...
        <div class="block-content block-content-full text-center bg-image" style="background-image: url('https://bing.img.run/rand.php');background-size: 100% 100%;">
            <div>
                <div>
    ...
    text-shadow: -0.1rem 0.1rem #FFFF8D, -0.2rem 0.2rem #CCFF90, -0.3rem 0.3rem #A7FFEB, -0.4rem 0.4rem #82B1FF, -0.5rem 0.5rem #B388FF, -0.6rem 0.6rem #EA80FC, -0.7rem 0.7rem #FF80AB, -0.8rem 0.8rem #FFD180;
        ...
        <div class="block-content block-content-mini block-content-full">
            <div class="btn-group btn-group-justified">
				<div class="btn-group"> 
<a class="btn btn-default" data-toggle="modal" href="/user/regsite.php"><img src="https://z3.ax1x.com/2021/06/19/RCRtyD.gif">&nbsp;<font color="#B008B"><span style="font-weight:bold">0成本代理</span></font></a>
					</div>
...
<div style="background-color:#333;border-radius: 25px;box-shadow: 0px 0px 5px #f200ff;padding:5px;margin-top: 10px;margin-bottom:0px;">
    ...
    <center><span style="font-size:10px;"><strong><span><span style="color:#E53333;">下单步骤<span style="color:#E53333;"> &gt; <span><span style="color:#E8E8E8;">选择分类</span></span> &gt; <span style="color:#009900;">选择商品<span style="color:#E53333;"> &gt; </span></span><span></span><span style="color:#EE33EE;">填写信息<span style="color:#E53333;"> &gt; </span><span style="color:#F08080;">下单成功</span></span></span></span></span></strong></span>
