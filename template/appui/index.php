...
$rs       = $DB->query("SELECT * FROM pre_message WHERE active=1 ORDER BY id DESC");
$msgrow   = array();
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">查询内容是什么？该输入什么？</h4>
      	...
      	<li class="list-group-item">例如您购买的是QQ**，输入下单的QQ账号即可查询订单</li>
      	<li class="list-group-item">例如您购买的是邮箱类商品，需要输入您的邮箱号，输入QQ号是查询不到的</li>
      	<li class="list-group-item">例如您购买的是**商品，需要输入作品链接里“userid=”后面的数字，输入**号是一般是查询不到的</li>
...
?>
	...
	<div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
						...
						<div class="block">
							<div class="block-title">
								<ul class="nav nav-tabs">
									...
									<?php if ($conf['zz_index_article'] == 1) {?>
										<li class="active"><a href="#news" data-toggle="tab"><i class="fa fa-bars"></i>&nbsp;公告通知</a></li>
									<?php }?>
		...
		<!--查询订单-->
		    <div class=" tab-pane fade-up" id="query">
		...
		<div class="tab-pane fade " id="gift">
			<?php include TEMPLATE_ROOT . 'default/gift.inc.php';?>
		</div>
		<!--抽奖-->
