...
<!--logo下面按钮-->
	<div class="widget-content text-center">
		<div class="text-center" style="color:#4A4A4A;">
			<div class="btn-group btn-group-justified">
				<div class="btn-group">
					<a class="btn btn-default" data-toggle="modal" href="#anounce"><i class="fa fa-bullhorn"></i>&nbsp;<span style="font-weight:bold">平台公告</span></a>
					 	...
					 	<a href="../sup" target="_blank" data-toggle="modal" class="btn btn-default"><i class="fa fa-shopping-cart"></i>&nbsp;<span style="font-weight:bold">供货商入驻</span></a>
			                <div class="btn-group">
                 <a class="btn btn-default" data-toggle="modal" href="../user/login.php"><i class="fa fa-users fa-1x"></i>&nbsp;登录/注册</a>
				</div>
             </div>
		</div>
		<center>
                   <a class="btn btn-default" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes" target="_blank"><span style="color:#4A4A4A;font-weight:bold">♛《售后/》 9:00-23:00  ♛人工客服中心♛</span></a>
            </center>
	</div>
...
<!--TAB标签开始-->
	<div class="block-title">
        <ul class="nav nav-tabs" data-toggle="tabs">
            <li style="width: 20%;" align="center"><a href="#nav"><i class="fa fa-navicon"></i> <b>导航</b></a></li>
            <li style="width: 20%;" align="center" class="active"><a href="#shop"><i class="fa fa-shopping-cart"></i> <b>下单</b></a></li>
            <li style="width: 20%;" align="center" class=""><a href="#search" id="tab-query"><i class="fa fa-search"></i> <b>查询</b></a></li>
			<?php if($conf['fenzhan_buy']==1){?><li style="width: 20%;" align="center"><a href="#Substation"><font color="#FF4000"><i class="fa fa-location-arrow fa-spin"></i> <b>分站</b></font></a></li><?php }?>
			<?php if($conf['gift_open']==1&&$conf['fenzhan_buy']==0){?><li style="width: 20%;" align="center"><a href="#gift" data-toggle="tab"><span style="font-weight:bold"><i class="fa fa-gift fa-fw"></i> 抽奖</span></a></li><?php }?>
			<?php if($conf['fenzhan_buy']==0&&$conf['gift_open']==0){?><li style="width: 20%;" align="center"><a onclick="window.location.href='./user/'"><span style="font-weight:bold"><i class="fa fa-user fa-fw"></i> 登录</span></a></li><?php }?>
            <li style="width: 20%;" align="center" class=""><a href="#more"><i class="fa fa-list"></i> <b>更多</b></a></li>
</ul>
<style>
    #nr{
     font-size:20px;
...
<p>
	<strong><span style="background-color:#FFE500;">
	<hr />
	</span></strong>
</p>
<span style="font-family:&quot;background-color:#FFE500;color:#000000;font-size:16px;">
    
</span><span style="font-family:&quot;background-color:#FFE500;color:#E53333;font-size:16px;"><strong><u>
</u></strong></span><span style="color:#646464;font-family:&quot;font-size:14px;background-color:#FFFFFF;"></span>
...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-5 center-block" style="float: none;">
<div  style=" z-index:9999; text-decoration:none; font-weight:bold; position: fixed; z-index: 999; Left: -6px; bottom: 198px; display: inline-block; width: 20px; border-top-left-radius: 10px; border-top-Left-radius: 5px; border-bottom-Left-radius: 5px; border-bottom-left-radius: 10px; color: white; font-size: 17px; line-height: 17px; box-shadow: rgb(100 149 237) 0px 0px 5px; word-wrap: break-word; padding: 8px 13px; border: 2px solid white; background: rgb(100 149 237);"><a href="../toollogs.php" target="_blank" style="position: relative;left: -7px;top: 2px; color:#ffffff;">商品上架通知</a></div>
</body>
</html>