...
if ($_GET['id'] && $row) {
    ...
    $seokeywords    = 'qq网,网教程,哪个网好用,网,,qq';
...
<div class="panel panel-default">
  ...
  <div class="btn-group btn-group-justified">
    ...
    <div class="btn-group">
      <a class="btn btn-default" data-toggle="modal" href="http://<?php echo $hosturl ?>/article/index.html"><i class="fa fa-bars"></i> <span style="font-weight:bold">文章首页</span></a>
    </div>
    <div class="btn-group">
...
if ($active === false) {
    ...
    ?>
              ...
              <?if (!$is_mb) {
        if ($lasetId) {?>
                  <span class="pull-left">上一篇&nbsp;<a href="http://<?php echo $hosturl; ?>/article/<?php echo $lasetId; ?>.html" title="<?php echo $lasetRow['title'] ?>"  style="color: blue"><?php echo $lasetRow['title']; ?></a></span>
                <?php } else {?>
                  <span class="pull-left"><a href="javascript:(0)" style="color: blue"><b>上一篇没有了</b></a></span>
                <?php }

        if ($prevId) {?>
                  <span class="pull-right"><a href="http://<?php echo $hosturl; ?>/article/<?php echo $prevId; ?>.html" title="<?php echo $prevRow['title'] ?>"  style="color: blue"><?php echo $prevRow['title']; ?></a>&nbsp;下一篇</span>
                <?php } else {?>
                  <span class="pull-right">下一篇&nbsp;<a href="javascript:(0)" style="color: blue"><b>没有了</b></a></span>
                <?php }?>
                <br>
            <?
    } else {
        if ($lasetId) {?>
                <div  style="display: block;">上一篇&nbsp;<a href="http://<?php echo $hosturl; ?>/article/<?php echo $lasetId; ?>.html" title="<?php echo $lasetRow['title'] ?>"  style="color: blue"><?php echo $lasetRow['title']; ?></a></div>
                <?php } else {?>
                  <div style="display: block;">上一篇&nbsp;&nbsp;<a href="javascript:(0)" style="color: blue"><b>没有了</b></a></div>
                <?php }

        if ($prevId) {?>
                  <div  style="display: block;">下一篇&nbsp;<a href="http://<?php echo $hosturl; ?>/article/<?php echo $prevId; ?>.html" title="<?php echo $prevRow['title'] ?>"  style="color: blue"><?php echo $prevRow['title']; ?></a></div>
                <?php } else {?>
...
<?php
    ...
    $type = '0,1';
    if ($_GET['kw'] && $conf['message_search'] == 1) { //搜索
