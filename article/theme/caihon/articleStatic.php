...
if (isset($_GET['id'])) {
    ...
    if (defined('HTTPS_ROOT') && HTTPS_ROOT) {
        $this_url = 'https://' . $hosturl . '/article/' . $row['id'] . '.html';
    } else {
        $this_url = 'http://' . $hosturl . '/article/' . $row['id'] . '.html';
    }
...
foreach ($msgrow as $row) {
        ...
        echo '<tr class="animation-fadeInQuick"><td><a href="../article/?id=' . $row['id'] . '.html"><div>
